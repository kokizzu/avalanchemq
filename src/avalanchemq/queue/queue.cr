    ...
    def details_tuple
      {
        ...
        ready_max_bytes: @ready.max &.bytesize,
        ready_min_bytes: @ready.min &.bytesize,
        ready_avg_bytes: @ready.avg &.bytesize,
        unacked: @unacked.size,
        unacked_bytes: @unacked.sum &.sp.bytesize,
        unacked_max_bytes: @unacked.max &.sp.bytesize,
        unacked_min_bytes: @unacked.min &.sp.bytesize,
        unacked_avg_bytes: @unacked.avg &.sp.bytesize,
